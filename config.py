...
from analytic.FAADMem import FAADMemLearner
...
ALL_METHODS: dict[str, type[Learner]] = {
    ...
    "FAAD-Mem": FAADMemLearner # The G-AIL is a generalization of the AIR for generalized CIL.
}
...
_model_group.add_argument(
    ...
    default=2048,
    type=int,
    help="The output dimension of the feature adaptation layer in FAAD-Mem.",
)
...
_model_group.add_argument(
    ...
    type=float,
    default=2.0,
    help="Temperature value used in knowledge distillation for FAAD-Mem.",
)
...
_model_group.add_argument(
    ...
    type=int,
    default=1,
    help="Number of feature vectors stored per class in FAAD-Mem memory bank.",
)
...
_il_group.add_argument(
    ...
    type=int,
    metavar="N",
    help="Number of total epochs to run for incremental learning.",
)
